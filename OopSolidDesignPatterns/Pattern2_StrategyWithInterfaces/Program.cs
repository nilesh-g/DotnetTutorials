...
// 2. Strategy Design Pattern using Interface
interface IDiscountStrategy
{
    double ApplyDiscount(double total);
}

class FlatDiscountLogic:IDiscountStrategy
{
...
class NoDiscountLogic : IDiscountStrategy
{
    public double ApplyDiscount(double total)
    {
        // apply discount
...
class FestivalDiscountLogic : IDiscountStrategy
{
    public double ApplyDiscount(double total)
    {
        // apply discount
...
class FoodOrderService
{
    ...
    private IDiscountStrategy discountLogic = null;
    ...
    public FoodOrderService(IPaymentProcessor processor, IDiscountStrategy discountStrategy)
    {
...
internal class Program
{
    static void Main(string[] args)
    {
        ...
        IDiscountStrategy discountStrategy = new FestivalDiscountLogic();
        FoodOrderService service = new FoodOrderService(processor, discountStrategy);
        service.PlaceOrder();
    }
}
